...
export function generateBookmarklet(configuredUrl: string): string {
  function bookmarkletFn(CONFIGURED_URL: string) {
    ...
    overlay.style.cssText =
      'position:fixed;top:0;left:0;width:100%;height:100%;z-index:2147483647;background:rgba(0,0,0,.6)';
    ...
    iframe.style.cssText =
      'position:absolute;top:50%;left:50%;transform:translate(-50%,-50%);width:min(500px,95vw);height:min(640px,90vh);border:none;border-radius:12px';
